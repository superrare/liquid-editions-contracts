...
import {LiquidLensDemoV3} from "liquid-editions/examples/LiquidLensDemoV3.sol";
import {ILiquid} from "liquid-editions/interfaces/ILiquid.sol";
import {console} from "forge-std/console.sol";
import {Script} from "forge-std/Script.sol";

/**
 * @title DeployLiquidLensDemoV3
 * @notice Script to deploy a LiquidLensDemoV3 ERC721 render contract and mint all tokens
 * @dev
 *
 * This script deploys the V3 hyper-reactive ERC721 render contract that reads market state from
 * a Liquid Edition and generates dynamic SVG artwork with hash-avalanche sensitivity.
 * It mints all 10 NFTs in the collection.
 *
 ...
 * - COLLECTION_NAME: Name for the NFT collection (default: "Liquid Lens V3 Collection")
 * - COLLECTION_DESCRIPTION: Description for the NFT collection (default: "Hyper-reactive generative collection where tiny market-state changes trigger major visual shifts")
 * - NFT_NAME: ERC721 token name (default: "Liquid Lens V3")
 * - NFT_SYMBOL: ERC721 token symbol (default: "LENS3")
 * - MINT_TO: Address to mint NFTs to (default: deployer address)
 *
 * Usage:
 *   forge script script/DeployLiquidLensDemoV3.s.sol:DeployLiquidLensDemoV3 --rpc-url $RPC_URL --broadcast
 *
 * Note: If you encounter gas limit errors, use --gas-limit flag:
 *   forge script script/DeployLiquidLensDemoV3.s.sol:DeployLiquidLensDemoV3 --rpc-url $RPC_URL --broadcast --gas-limit 30000000
 */
contract DeployLiquidLensDemoV3 is Script {
    function run() external {
        ...
        try vm.envString("COLLECTION_NAME") returns (string memory name) {
            ...
            collectionName = "Liquid Lens V3 Collection";
        }
        ...
        try vm.envString("COLLECTION_DESCRIPTION") returns (string memory desc) {
            ...
            "Hyper-reactive generative collection where tiny market-state changes trigger major visual shifts";
        }
        ...
        console.log("=== DEPLOYING LIQUID LENS DEMO V3 ===");
        console.log("");
        ...
        // Deploy the LiquidLensDemoV3 contract
        console.log("Deploying LiquidLensDemoV3 contract...");
        LiquidLensDemoV3 lens =
            new LiquidLensDemoV3(liquidEditionAddress, nftName, nftSymbol, collectionName, collectionDescription);

        console.log("LiquidLensDemoV3 deployed at:");
        ...
        console.log("");
        console.log("LiquidLensDemoV3 Contract:");
        console.logAddress(address(lens));
        console.log("");
        ...
        console.log("5. Tiny market-state changes should produce visibly different rendered output");
        console.log("");
