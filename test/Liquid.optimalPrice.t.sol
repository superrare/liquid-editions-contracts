...
contract LiquidOptimalPriceTest is Test {
    ...
    function _createToken(uint256 rareAmount) internal returns (Liquid) {
        ...
        vm.stopPrank();
        return Liquid(payable(tokenAddress));
    }
    ...
    function test_AllRAREUsed_NoLeftovers() public {
        ...
        // Create token
        Liquid token = _createToken(RARE_AMOUNT);
    ...
    function test_OptimalPrice_VariousRAREAmounts() public {
        ...
        for (uint256 i = 0; i < rareAmounts.length; i++) {
            ...
            Liquid token = _createToken(rareAmounts[i]);
    ...
    function testFuzz_AllRAREUsed(uint256 rareAmount) public {
        ...
        Liquid token = _createToken(rareAmount);
